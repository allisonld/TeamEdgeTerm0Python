...
name = "Allison"
grade = 12
funFact = "I wrote a novel in 9th grade"
...
firstLine = "happy birthday to you"
secondLine = firstLine
thirdLine = "happy birthday dear faith"
fourthLine = firstLine

print(f"{firstLine} {secondLine} {thirdLine} {fourthLine}")

# **** Challenge 1: Problem 3 ****
# Print out a string that has brackets in it.


print("here are some numbers[4]")
...
differencebtwn7andSum = 7 - sum

print(differencebtwn7andSum)

# # **** Challenge 2: Problem 3 ****
# # Store the product of the difference and 3 in a variable.
# # Print the product.

productOfDifferenceAnd3 = differencebtwn7andSum * 3
print(productOfDifferenceAnd3)

# # **** Challenge 2: Problem 4 ****
# # Store the power of the product squared in a variable.
# # Print the power.

powerofProductSquared = productOfDifferenceAnd3 * productOfDifferenceAnd3
print(powerofProductSquared)
# # **** Challenge 2: Problem 5 ****
# # Store the quotient of the power divided by 4 in a variable.
# # Print the quotient.

quotientOfThePowerDividedBy4 = powerofProductSquared / 4

# # **** Challenge 2: Problem 6 ****
# # Store the remainder of the quotient divided by 2 in a variable.
# # Print the remainder.

remainderquotientDividedBy2 = quotientOfThePowerDividedBy4 % 2
print(remainderquotientDividedBy2)
