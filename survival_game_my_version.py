...
camp_area.description ="You see a thin trail of smoke floating up from a recently put-out fire. You feel a bit of apprehension. The camp's inhabitants haven't been gone long..."
camp_area.items = []
...
cave.description =""
cave.items = ["fish"]
cave.paths =["camp", "field with flowers",""]
cave.npcs = []
cave.visited = False
